                ...
                <table class="table table-bordered align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="fw-bold text-center bg-light">
                            ...
                            <td colspan="2">{{ $examResult['percentage'] }}%</td>
                        </tr>
                        <tr class="fw-bold text-center bg-light">
                            <td colspan="8" class="text-end">Final Grade:</td>
                            <td colspan="2">{{ $examResult['overallGrade'] ?? '-' }}</td>
                        </tr>
                        <tr class="fw-bold text-center bg-light">
                            <td colspan="8" class="text-end">Result:</td>
                            <td colspan="2">
