...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="card flex-fill student-space comman-shadow">
            <form method="GET" action="{{ route('teacher.student.attendance.report') }}" class="card p-3 mb-4">
                <div class="row">
                    <div class="col-md-2">
                ...
                <div class="mt-3 text-end">
                    ...
                    <a href="{{ route('teacher.student.attendance.report') }}" class="btn btn-success">Reset</a>
                </div>
            </form>
        </div>
